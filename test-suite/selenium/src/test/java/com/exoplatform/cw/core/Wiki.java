...
public class Wiki extends BaseTest
{
   private interface Locators
   {
      ...
      String IS_FIRST_ELEMENT_SELECT_IN_MOVE_WIN =
         "//div[@id='UIMoveTree']//div[@class='NodeGroup']/div[@class='LastNode Node']//div[@id='iconTreeExplorer' and @class='Wikihome TreeNodeType Node   Hover']/div/a[text()='Wiki Home']";
   ...
   public void waitAddWiki() throws Exception
   {
      new WebDriverWait(driver, 7).until(new ExpectedCondition<Boolean>()
      {
         ...
         {
            return helpContainer != null && helpContainer.isDisplayed() && editorBtnContainer != null
               && editorBtnContainer.isDisplayed() && titleAddPage != null && titleAddPage.isDisplayed();
         }
      });
   }
...
//    * @throws Exception
//    */
//   public void waitSearchResult() throws Exception
//   {
//      new WebDriverWait(driver, 5).until(new ExpectedCondition<Boolean>()
//      {
//         @Override
...
//   }
   ...
   /**
    * wait document in first position
   ...
   public void waitDocInFirstPosition(final String docname) throws Exception
   {
      new WebDriverWait(driver, 5).until(new ExpectedCondition<Boolean>()
      {
         ...
         {
            WebElement doc =
               driver.findElement(By.xpath(String.format(Locators.FIRST_DOC_IN_THREE_IN_DESIRED_POSITION, docname)));
   ...
   /**
    * wait document in second position
    * with the specified name
    * @param docname
    * @throws Exception
    */
   public void waitDocInSecondPosition(final String docname) throws Exception
   {
      new WebDriverWait(driver, 5).until(new ExpectedCondition<Boolean>()
      {
         ...
         {
            WebElement doc =
               driver.findElement(By.xpath(String.format(Locators.SECOND_DOC_IN_THREE_IN_DESIRED_POSITION, docname)));
            return doc != null && doc.isDisplayed();
         }
      });
   }
   ...
   public void waitSelectRootElemMoveForm() throws Exception
   {
      new WebDriverWait(driver, 10).until(new ExpectedCondition<Boolean>()
      {
         ...
         public Boolean apply(WebDriver elem)
         {
            return isFirstElemSelectMoveWin != null && isFirstElemSelectMoveWin.isDisplayed();
         }
      });
   }
   ...
   public void watchDialogclose() throws Exception
   {
      new WebDriverWait(driver, 5).until(new ExpectedCondition<Boolean>()
      {
         ...
         public Boolean apply(WebDriver elem)
         {
            try
            {
               return driver.findElement(By.xpath(Locators.TITLE_WATCH_DIALOG_FORM)).isDisplayed();
            }
            catch (Exception e)
            {
               return true;
   ...
   public void waitLink(final String link) throws Exception
   {
      new WebDriverWait(driver, 20).until(new ExpectedCondition<Boolean>()
      {
         ...
         public Boolean apply(WebDriver elem)
         {
            WebElement lnk = driver.findElement(By.linkText(String.format(Locators.UNIQUE_LINK_NAME, link)));
   ...
   public void waitWikiHome() throws Exception
   {
      new WebDriverWait(driver, 20).until(new ExpectedCondition<Boolean>()
      {
         ...
         public Boolean apply(WebDriver elem)
         {
            ...
            return leftAreaWikiHome != null && leftAreaWikiHome.isDisplayed() && mainMenuWikiHome != null
               && mainMenuWikiHome.isDisplayed() && moreMenu != null && moreMenu.isDisplayed();
         }
      });
   }
   ...
   {
      driver.findElement(By.linkText(String.format(Locators.UNIQUE_LINK_NAME, nameLink))).click();
   }
   ...
   {
      driver.findElement(By.xpath(String.format(Locators.NODE_SELECTOR_MOVE_FORM, item))).click();
   }

   public void isElemFirstPositionThreePresent(String name)
   {
      driver.findElement(By.xpath(String.format(Locators.NODE_SELECTOR_MOVE_FORM, name))).click();
   }
