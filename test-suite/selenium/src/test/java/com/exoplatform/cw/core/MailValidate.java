...
public class MailValidate extends BaseMail
{
   ...
   private interface Locators
   {
      ...
      String CLOUD_WORKSPACE_WELCOME_MAIL =
         "//tbody/tr[1]//span[@id]/b[contains(.,'Welcome to the exoplatform Social Intranet')]";
   ...
   {
      return loginField.isDisplayed() && passField.isDisplayed() && btnLogin.isDisplayed();
   }
   ...
   public void waitGmailLoginForm() throws Exception
   {
      new WebDriverWait(driver, 10).until(new ExpectedCondition<Boolean>()
      {
         ...
         {
            return loginField != null && loginField.isDisplayed() && passField != null && passField.isDisplayed();
         }
      });
   }
   ...
   public void waitIframeWithMail() throws Exception
   {
      new WebDriverWait(driver, 10).until(new ExpectedCondition<Boolean>()
      {
         ...
         public Boolean apply(WebDriver elem)
         {
            try
            {
               return iframeWithMails != null && iframeWithMails.isDisplayed();
            }
            catch (Exception e)
            {
               return false;
   ...
   public void waitWelcomMailForOwner() throws Exception
   {
      new WebDriverWait(driver, 20).until(new ExpectedCondition<Boolean>()
      {
         ...
         public Boolean apply(WebDriver elem)
         {
            return checkBetaMessage != null && checkBetaMessage.isDisplayed();
         }
      });
   }
