...
# custom JAVA options
[ -z "$EXO_JAVA_OPTS" ]  && EXO_JAVA_OPTS="-Xms1024m -Xmx1400m -XX:MaxPermSize=256m"
...
EXO_CLOUD_OPTS="-javaagent:../lib/cloud-agent-instrument-1.1-M9-SNAPSHOT.jar=../gatein/conf/cloud/agent-configuration.xml \
