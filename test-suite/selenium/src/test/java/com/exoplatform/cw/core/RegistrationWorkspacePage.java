	...
	public void waitRegistrationForm() throws Exception {
		new WebDriverWait(driver, 30).until(new ExpectedCondition<Boolean>() {
			...
			public Boolean apply(WebDriver elem) {
				...
				return registrationFormBlock != null
						&& registrationFormBlock.isDisplayed()
						&& emailField != null && emailField.isDisplayed()
						&& firstNameField != null
						&& firstNameField.isDisplayed()
						&& lastNameField != null && lastNameField.isDisplayed()
						&& phoneField != null && phoneField.isDisplayed()
						&& companyField != null && companyField.isDisplayed()
						&& usernameField != null && usernameField.isDisplayed()
						&& passwordField != null && passwordField.isDisplayed()
