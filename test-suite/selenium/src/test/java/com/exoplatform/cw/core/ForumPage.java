...
public class ForumPage extends BaseTest
{
   ...
   private interface Locators
   {
      ...
      String FOOTER_POST_MASSAGE_CONTAINER =
         "//table[@class='TablePost ContentContainer'][%s]//div[@class=\"FootPost ClearFix\"]";

      String BUTTON_POST_MASSAGE_CONTAINER = FOOTER_POST_MASSAGE_CONTAINER + "//a[text()='%s']";
   ...
   public void waitOpen() throws Exception
   {
      new WebDriverWait(driver, 10).until(new ExpectedCondition<Boolean>()
      {
         ...
         {
            WebElement lnk = driver.findElement(By.xpath(Locators.LAST_ELEMENT_ON_PAGE));
    ...
    * @throws Exception
    */
   public void waitFileNameOnUploadForm(final String fileName) throws Exception
   {
      new WebDriverWait(driver, 10).until(new ExpectedCondition<Boolean>()
      {
         @Override
         public Boolean apply(WebDriver elem)
         {
            WebElement fl = driver.findElement(By.xpath(String.format(Locators.FILE_NAME_LABEL, fileName)));
   ...
   public void waitAttacmentImage(final String img) throws Exception
   {
      new WebDriverWait(driver, 5).until(new ExpectedCondition<Boolean>()
      {
         ...
         {
            WebElement image =
               driver.findElement(By.cssSelector(String.format(Locators.IMAGE_ALT_ATTRIBUTE_CLASS, img)));
   ...
   public void waitAttacmentTitleImage(final String tit) throws Exception
   {
      new WebDriverWait(driver, 5).until(new ExpectedCondition<Boolean>()
      {
         ...
         public Boolean apply(WebDriver elem)
         {
            WebElement title = driver.findElement(By.cssSelector(String.format(Locators.LINK_TITLE_CLASS, tit)));
   ...
   public void waitCloseUploadForm() throws Exception
   {
      new WebDriverWait(driver, 5).until(new ExpectedCondition<Boolean>()
      {
         ...
         public Boolean apply(WebDriver elem)
         {
            try
            {
               WebElement visible = driver.findElement(By.id(Locators.UPLOAD_FORM_ID));
               return false;
            }
            catch (Exception e)
            {
   ...
   public void waitTopicForm() throws Exception
   {
      new WebDriverWait(driver, 10).until(new ExpectedCondition<Boolean>()
      {
         ...
         public Boolean apply(WebDriver elem)
         {
            return lastTopicFormContainer != null && lastTopicFormContainer.isDisplayed();
         }
      });
   }
   ...
   public void waitPostFormClosed() throws Exception
   {
      new WebDriverWait(driver, 10).until(new ExpectedCondition<Boolean>()
      {
         ...
         public Boolean apply(WebDriver elem)
         {
            ...
            try
            {
               WebElement element = driver.findElement(By.id(Locators.LAST_CONTAINER_NEW_POST_FORM_ID));
               return false;
            }
            catch (Exception e)
            {
   ...
   public void waitTopicFormClosed() throws Exception
   {
      new WebDriverWait(driver, 20).until(new ExpectedCondition<Boolean>()
      {
         ...
         public Boolean apply(WebDriver elem)
         {
            try
            {
               WebElement visible = driver.findElement(By.className(Locators.LAST_CONTAINER_NEW_TOPIC_FORM_ID));
               return false;
            }
            catch (Exception e)
            {
   ...
   /**
    * wait post messages on discution forum
    * start with first mess
    * @param mess
    * @throws Exception
    */
      ...
      new WebDriverWait(driver, 5).until(new ExpectedCondition<Boolean>()
      {
         ...
         public Boolean apply(WebDriver elem)
         {
            WebElement messageContainer =
               driver.findElement(By.xpath(String.format(Locators.FOOTER_POST_MASSAGE_CONTAINER, mess)));
            return messageContainer != null && messageContainer.isDisplayed();
         }
      });
   }
   ...
   public void waitNewLinkAppearWithPrefix(final String link) throws Exception
   {
      new WebDriverWait(driver, 10).until(new ExpectedCondition<Boolean>()
      {
         ...
         public Boolean apply(WebDriver elem)
         {
            WebElement lnk = driver.findElement(By.partialLinkText(String.format(Locators.LINKS_ON_FORUM_PAGE, link)));
            return lnk != null && lnk.isDisplayed();
         }
      });
   }
   ...
   public void waitMessageIframe() throws Exception
   {
      new WebDriverWait(driver, 10).until(new ExpectedCondition<Boolean>()
      {
         ...
         public Boolean apply(WebDriver elem)
         {
           return editableMessageIframe != null && editableMessageIframe.isDisplayed();
         }
      });
   }
   ...
   public void waitNewLinkAppear(final String link) throws Exception
   {
      new WebDriverWait(driver, 10).until(new ExpectedCondition<Boolean>()
      {
         ...
         public Boolean apply(WebDriver elem)
         {
            WebElement lnk = driver.findElement(By.linkText(String.format(Locators.LINKS_ON_FORUM_PAGE, link)));
            return lnk != null && lnk.isDisplayed();
         }
      });
   }
    ...
    * @throws Exception
    */
   public void clickOnTopic(int numTopic) throws Exception
   {
      WebElement topic = driver.findElement(By.xpath(String.format(Locators.TOPIC_SELECTION, numTopic)));
      topic.click();
   }
   ...
   /**
    * click on first find link with the specified name
    * in DOM forum  page
    * @param link
    */
   public void clickOnLinkForumPage(String link)
   {
      driver.findElement(By.linkText(String.format(Locators.LINKS_ON_FORUM_PAGE, link))).click();

   }

   /**
    * return text from disscutions messages
    * start with 1
   * @param numMess
   * @return
   */
   ...
   {
      WebElement mess = driver.findElement(By.xpath(String.format(Locators.POST_MASSAGE_CONTAINER, numMess)));
      return mess.getText();
   }
   ...
   {
      WebElement mess =
         driver.findElement(By.xpath(String.format(Locators.BUTTON_POST_MASSAGE_CONTAINER, numMess, nameBtn)));
      mess.click();
   }
   ...
   {
      driver.findElement(By.partialLinkText(String.format(Locators.LINKS_ON_FORUM_PAGE, link))).click(); 
   }
