...
public class Calendar extends BaseTest {
	private interface Locators {
		...
		String WEEK_TABLE = "UICalendarWorkingContainer";
		...
		String TASK_FORM_SET_FROM_DATE = TASK_FORM_PREFIX
				+ "//div[@class='Date']/input";

		String TASK_FORM_SET_FROM_TIME = "//div[@id='UIQuckAddTaskPopupWindow']//div[@class=\"UIComboboxComponent\"]/input[@class='UIComboboxInput']";

		String TASK_FORM_SET_TO_DATE = "//div[@id='UIQuckAddTaskPopupWindow']//table/tbody/tr[4]//div[@class='Date']/input";

		String TASK_FORM_SET_TO_TIME = "//div[@id='UIQuckAddTaskPopupWindow']//table/tbody/tr[4]//div[@class='Time']//input[@class='UIComboboxInput']";

		String TASK_SAVE_BTN = TASK_FORM_PREFIX + "//a[text()='Save']";

		String TASK_CANCEL_BTN = TASK_FORM_PREFIX + "//a[text()='Cancel']";

		String TASK_MORE_DETAILS_BTN = TASK_FORM_PREFIX
				+ "//a[text()='More Details']";
		...
		String TASK_FORM_CLICK_CALENDAR_COMBOBOX = TASK_FORM_PREFIX
		...
		String TASK_SELECT_WS_CALENDAR = TASK_FORM_PREFIX
				+ EVENT_SELECT_WS_CALENDAR;
		...
		String DELETE_BY_CTX_MENU = "//a[@class=\"ItemIcon DeleteEventIcon\" and contains(.,\"Delete\")]";

		String SEARCH_INPUT = "//div[@title=\"Search\"]//input[@id=\"value\"]";

		String SEARCH_RESULT = "//div[@id=\"UIListContainer\"]//span[contains(.,\"%s\")]";

		String CALENDAR_TOP_BUTTONS_BY_NAME = "//div[@class=\"CenterBar\"]//a[contains(.,\"%s\")]";

	}

	@FindBy(id = Locators.WEEK_TABLE)
	...
	@FindBy(xpath = Locators.DELETE_BY_CTX_MENU)
	private WebElement deleteItemByCtxMenu;
	 ...
	 * @param numMess
	 * @throws Exception
	 *             wait appearance table from Calendar
	 */
	...
	/**
	 * wait appearence event on Weekly table
	 * 
	 * @param titleEvent
	 */
	public void waitTaskOrEventAppearence(final String titleEvent) {

		new WebDriverWait(driver, 60).until(new ExpectedCondition<Boolean>() {
			@Override
			public Boolean apply(WebDriver elem) {
				WebElement event = driver.findElement(By.xpath(String.format(
						Locators.EVENT_CONTAINER, titleEvent)));
	...
	/**
	 * wait disappear event in Weekly table
	 * 
	 * @param titleEvent
	 */
	public void waitTaskOrEventDisappearing(final String titleEvent) {
	...
	/**
	 * wait basic elements of event form
	 * 
	 * @throws Exception
	 */
	public void waitEventForm() throws Exception {
		new WebDriverWait(driver, 30).until(new ExpectedCondition<Boolean>() {
			@Override
			public Boolean apply(WebDriver elem) {
				return saveBtn != null && saveBtn.isDisplayed()
						&& moreDetBtn != null && moreDetBtn.isDisplayed()
						&& cancelBtn != null && cancelBtn.isDisplayed()
						&& eventSummaryField != null
						&& eventSummaryField.isDisplayed()
						&& eventFromDateField != null
						&& eventFromDateField.isDisplayed();
			}
		});
	}

	/**
	 * wait basic elements of task form
	 * 
	 * @throws Exception
	 */
	public void waitTaskForm() throws Exception {
		new WebDriverWait(driver, 30).until(new ExpectedCondition<Boolean>() {
			@Override
			public Boolean apply(WebDriver elem) {
				return taskForm != null && taskForm.isDisplayed()
						&& taskSaveBtn != null && taskSaveBtn.isDisplayed()
						&& taskEventField != null
						&& taskEventField.isDisplayed();
			}
		});
	}
	...
	public void clickOnWeeklyTable(int col, int row) {
		driver.findElement(
				By.xpath(String.format(Locators.WEEKLY_TABLE_NAVIGATION, col,
						row))).click();
	}

	/**
	 * type to summary field of event form
	 */
	...
	/**
	 * type to task field of event form
	 */
	...
	/**
	 * type to task From time field of event form
	 */
	...
	/**
	 * type to task To time field of event form
	 */
	...
	/**
	 * type to description field of event form
	 * 
	 * @param description
	 */
	...
	/**
	 * set time in "set from time field" of event form
	 * 
	 * @param time
	 */
	...
	/**
	 * set date in "set from date field" of event form
	 * 
	 * @param time
	 */
	...
	/**
	 * set time in "set to time field" of event form
	 * 
	 * @param time
	 */
	...
	/**
	 * click on save button of event form
	 * 
	 * */
	 ...
	 * */
	public void selectWorkSpaceEventForm(String name)
			throws InterruptedException {

		WebElement elem = driver.findElement(By.xpath(String.format(
				Locators.EVENT_SELECT_WS_CALENDAR, name)));
	...
	public void selectWorkSpaceTaskForm(String name) {
		WebElement elem = driver.findElement(By.xpath(String.format(
				Locators.TASK_SELECT_WS_CALENDAR, name)));
		new Actions(driver).doubleClick(elem).build().perform();
	}

	/**
	 * click on checkbox for select workspace in calendar
	 * 
	 * */
	public void clicOnCheckBoxSelecWs(String name) {
		driver.findElement(
				By.partialLinkText(String.format(
						Locators.SELECT_WORKSPACE_LINK, name))).click();
	}
	 ...
	 * @throws InterruptedException
	 * */
	public void eventContexMenu(String name) throws InterruptedException {
		WebElement elem = driver.findElement(By.xpath(String.format(
				Locators.EVENT_CONTAINER, name)));
		new Actions(driver).contextClick(elem).build().perform();
	}

	/**
	 * Delete item by context menu
	 */
	public void deleteCalendarEvent() {
		deleteItemByCtxMenu.click();
	}

	/**
	 * Verify that event deleted
	 * 
	 * @param text
	 * @throws Exception
	 */

	public void verifyThatEventDeleted(final String text) throws Exception {
		new WebDriverWait(driver, 30).until(new ExpectedCondition<Boolean>() {
			@Override
			public Boolean apply(WebDriver input) {
				try {
					input.findElement(By.xpath(String.format(
							Locators.EVENT_CONTAINER, text)));
					return false;
	 ...
	 * @throws Exception
	 */
	public void checkSearchResult(final String text) throws Exception {
		new WebDriverWait(driver, 30).until(new ExpectedCondition<Boolean>() {
			@Override
			public Boolean apply(WebDriver elem) {
				WebElement lnk = driver.findElement(By.xpath(String.format(
						Locators.SEARCH_RESULT, text)));
	...
	/**
	 * Click on top calendar buttons
	 * 
	 * @param buttonName
	 */
	public void clickOnTopCalendarButton(String buttonName) {
		driver.findElement(
				By.xpath(String.format(Locators.CALENDAR_TOP_BUTTONS_BY_NAME,
						buttonName))).click();
	}
}
