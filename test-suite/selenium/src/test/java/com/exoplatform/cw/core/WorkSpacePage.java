...
public class WorkSpacePage extends BaseTest
{
   ...
   private interface Locators
   {
      ...
      String COMMENT_LINK = NUM_MESSAGES + "//div/a[@class and contains(text(), \"Comment\" )]";

      String LIKE_LINK = NUM_MESSAGES + "//div/a[@id and contains(text(), \"Like\" )]";

      String UNLIKE_LINK = NUM_MESSAGES + "//div/a[@id and contains(text(), \"Unlike\" )]";

      String COMMENT_MESSAGE_CLASS = NUM_MESSAGES + "//div[@class=\"CommentBlockBound\"]";

      String GET_COMMENT_CLASS = COMMENT_MESSAGE_CLASS + "//p[@class=\"ContentBlock\"]";

      String COMMENT_BOX_CLASS = COMMENT_MESSAGE_CLASS + "//div[@class=\"CommentInputBox\"]/textarea";

      String COMMENT_BUTTON_CLASS = "//input[@class=\"CommentButton DisplayNone\"]";

      String LIKE_APPERENCE_CLASS = NUM_MESSAGES + "//div[@class=\"ListPeopleContent\"]";
   ...
   @FindBy(xpath = Locators.SHARE_BUTTON)
   ...
   public void waitLikeAppear(final int numMess) throws Exception
   {
      new WebDriverWait(driver, 3).until(new ExpectedCondition<Boolean>()
      {
         ...
         public Boolean apply(WebDriver elem)
         {
            try
            {
               WebElement comment = driver.findElement(By.xpath(String.format(Locators.LIKE_APPERENCE_CLASS, numMess)));
   ...
   public void waitNewLinkAppear(final String link) throws Exception
   {
      new WebDriverWait(driver, 10).until(new ExpectedCondition<Boolean>()
      {
         ...
         public Boolean apply(WebDriver elem)
         {
            WebElement lnk = driver.findElement(By.linkText(String.format(Locators.LINKS_ON_MAIN_PAGE, link)));
   ...
   public void waitCommentLinkAppear(final int numMess) throws Exception
   {
      new WebDriverWait(driver, 5).until(new ExpectedCondition<Boolean>()
      {
         ...
         public Boolean apply(WebDriver elem)
         {
            try
            {
               WebElement comment = driver.findElement(By.xpath(String.format(Locators.COMMENT_LINK, numMess)));
               return comment != null && comment.isDisplayed();
   ...
   public void waitPostComment(final int numMess) throws Exception
   {
      new WebDriverWait(driver, 3).until(new ExpectedCondition<Boolean>()
      {
         ...
         public Boolean apply(WebDriver elem)
         {
            ...
            {
               WebElement comment =
                  driver.findElement(By.xpath(String.format(Locators.COMMENT_MESSAGE_CLASS, numMess)));
               return comment != null && comment.isDisplayed();
   ...
   public void waitSendCommentBtn(final int numMess) throws Exception
   {
      new WebDriverWait(driver, 3).until(new ExpectedCondition<Boolean>()
      {
         ...
         public Boolean apply(WebDriver elem)
         {
            ...
            {
               WebElement mess =
                  driver.findElement(By.xpath(String.format(Locators.NUM_MESSAGES + Locators.COMMENT_BUTTON_CLASS,
                     numMess)));
   ...
   public void waitMessage(final int numMess) throws Exception
   {
      new WebDriverWait(driver, 3).until(new ExpectedCondition<Boolean>()
      {
         ...
         public Boolean apply(WebDriver elem)
         {
            try
            {
               WebElement mess = driver.findElement(By.xpath(String.format(Locators.NUM_MESSAGES, numMess)));
               return mess != null && mess.isDisplayed();
   ...
   public void waitCommentBox(final int numMess) throws Exception
   {
      new WebDriverWait(driver, 5).until(new ExpectedCondition<Boolean>()
      {
         ...
         public Boolean apply(WebDriver elem)
         {
            try
            {
               WebElement mess = driver.findElement(By.xpath(String.format(Locators.COMMENT_BOX_CLASS, numMess)));
               return mess != null && mess.isDisplayed();
            }
            catch (Exception e)
            {
    ...
    * @param numMess
    * @throws Exception
    *  wait appearance comment-message
    *  from CW page
    *  num start with 1
    */
   public void waitCommentMessage(final int numMess) throws Exception
   {
      new WebDriverWait(driver, 3).until(new ExpectedCondition<Boolean>()
      {
         ...
         public Boolean apply(WebDriver elem)
         {
            try
            {
               WebElement mess = driver.findElement(By.xpath(String.format(Locators.COMMENT_MESSAGE_CLASS, numMess)));
               return mess != null && mess.isDisplayed();
   ...
   public void waitBasicElements() throws Exception
   {
      new WebDriverWait(driver, 30).until(new ExpectedCondition<Boolean>()
      {
         ...
         public Boolean apply(WebDriver elem)
         {
            try
            {
               return statusField != null && statusField.isDisplayed() && shareBtn != null && shareBtn.isDisplayed()
                  && calendIframe != null && calendIframe.isDisplayed();
            }
            catch (Exception e)
            {
               return false;
   ...
   public void waitMessageAfterCommClick(final int numMess) throws Exception
   {
      new WebDriverWait(driver, 3).until(new ExpectedCondition<Boolean>()
      {
         ...
         public Boolean apply(WebDriver elem)
         {
            try
            {
               WebElement mess = driver.findElement(By.xpath(String.format(Locators.GET_COMMENT_CLASS, numMess)));
               return mess != null && mess.isDisplayed();
   ...
   {
      WebElement post = driver.findElement(By.xpath(String.format(Locators.POST_MESSAGES, numMess)));
      return post.getText();
   }
   ...
   {
      WebElement lnk=  driver.findElement(By.xpath(String.format(Locators.COMMENT_LINK, num)));
   ...
   {
      WebElement mess =
         driver.findElement(By.xpath(String.format(Locators.NUM_MESSAGES + Locators.COMMENT_BUTTON_CLASS, numMess)));
      mess.click();
   }
   ...
   {
      WebElement comment = driver.findElement(By.xpath(String.format(Locators.GET_COMMENT_CLASS, numMess)));
   ...
   {
      WebElement like = driver.findElement(By.xpath(String.format(Locators.LIKE_LINK, numMess)));
      like.click();
   }
   ...
   {
      WebElement title = driver.findElement(By.xpath(String.format(Locators.TITLE_MESSAGE, numMessage)));
