...
{	// Create our Plugin function, with $ as the argument (we pass the jQuery object over later)
	...
	{	// Our LightboxClass definition
		...
		files: {
			compressed: {
				scripts: {
					lightbox:	'/balupton-jquery-lightbox/scripts/jquery.lightbox.min.js',
					colorBlend:	'/balupton-jquery-lightbox/scripts/jquery.color.min.js'
				},
				styles: {
					lightbox:	'/balupton-jquery-lightbox/styles/jquery.lightbox.min.css'
				}
			},
			uncompressed: {
				scripts: {
					lightbox:	'/balupton-jquery-lightbox/scripts/jquery.lightbox.js',
					colorBlend:	'/balupton-jquery-lightbox/scripts/jquery.color.js'
				},
				styles: {
					lightbox:	'/balupton-jquery-lightbox/styles/jquery.lightbox.css'
				}
			},
			images: {
				prev:		'/balupton-jquery-lightbox/images/prev.gif',
				next:		'/balupton-jquery-lightbox/images/next.gif',
				blank:	'/balupton-jquery-lightbox/images/blank.gif',
				loading:	'/balupton-jquery-lightbox/images/loading.gif'
			}
		},
