...
{
   public static  ResourceBundle CW_SETTINGS = ResourceBundle.getBundle("conf/cw-selenium");

   public static final String MAIL_ADRESS = CW_SETTINGS.getString("cw.corp.mail");

   public static final String CW_HOST = CW_SETTINGS.getString("cw.host");
   ...
   public static void start() throws Exception
   {
      ...
      selenium = new WebDriverBackedSelenium(driver, MAIL_ADRESS);
      CW = new CW(selenium(), MAIL_ADRESS, driver);
      try
      {
