...
${CATALINA_HOME}/lib/slf4j-api.jar:$CATALINA_HOME/lib/security-logback-logging-1.1-M9-SNAPSHOT.jar:${CATALINA_HOME}/lib/logback-classic.jar:${CATALINA_HOME}/lib/logback-core.jar:\
