...
define(["jquery", "marketo.form", "cloud/marketo"], function(Mkto) {

	function MarketoCookies() {
		...
		/* Set cookies to the document */
		this.set = function(document) {
			//
