...
public class FooterUIElements extends BaseTest {
	...
	private interface Locators {
		...
		String FOOTER_COPYRIGHT_LABEL = "//p[@class=\"Copyright FR\"and text()='Copyright © 2000-2012. All Rights Reserved, eXo Platform SAS.']";
	}
	...
	public void waitFooterElements() throws Exception {
		new WebDriverWait(driver, 30).until(new ExpectedCondition<Boolean>() {
			...
			public Boolean apply(WebDriver elem) {
				...
				return footerContainer != null && footerContainer.isDisplayed()
						&& brouthToYouBy != null && brouthToYouBy.isDisplayed()
						&& copyrightInfo != null && copyrightInfo.isDisplayed();
