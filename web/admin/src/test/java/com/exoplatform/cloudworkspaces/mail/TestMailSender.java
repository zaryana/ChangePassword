...
public class TestMailSender {
  ...
  public void initMocks() {
    ...
    MailSender wks_sender = new MailSender(cloudAdminConfiguration);
  ...
  public void testsOkToJoinEmail() throws Exception {
    ...
    cloudAdminConfiguration.setProperty(MailingProperties.CLOUD_ADMIN_MAIL_JOIN_TEMPLATE,
                                        "target/test-classes/template/OkToJoinEmail.html");
    cloudAdminConfiguration.setProperty(MailingProperties.CLOUD_ADMIN_MAIL_JOIN_SUBJECT,
                                        MESSAGE_SUBJECT);
    ...
    Assert.assertTrue(oneEmail.getHeaderValue("From").contains("support")); // its
                                                                            // not
                                                                            // an
                                                                            // admin
                                                                            // email
  ...
  public void testsSendJoinRejectedEmails() throws Exception {
    ...
    cloudAdminConfiguration.setProperty(MailingProperties.CLOUD_ADMIN_MAIL_JOIN_CLOSED_USER_TEMPLATE,
                                        "target/test-classes/template/JoinRejectedEmail.html");
    cloudAdminConfiguration.setProperty(MailingProperties.CLOUD_ADMIN_MAIL_JOIN_CLOSED_USER_SUBJECT,
                                        USER_SUBJECT);

    cloudAdminConfiguration.setProperty(MailingProperties.CLOUD_ADMIN_MAIL_JOIN_CLOSED_OWNER_TEMPLATE,
                                        "target/test-classes/template/JoinRejectedEmail.html");
    cloudAdminConfiguration.setProperty(MailingProperties.CLOUD_ADMIN_MAIL_JOIN_CLOSED_OWNER_SUBJECT,
                                        OWNER_SUBJECT);

    cloudAdminConfiguration.setProperty(MailingProperties.CLOUD_ADMIN_MAIL_JOIN_CLOSED_SALES_TEMPLATE,
                                        "target/test-classes/template/JoinRejectedEmail.html");
    cloudAdminConfiguration.setProperty(MailingProperties.CLOUD_ADMIN_MAIL_JOIN_CLOSED_SALES_SUBJECT,
                                        SALES_SUBJECT);
    cloudAdminConfiguration.setProperty(MailingProperties.CLOUD_ADMIN_MAIL_SALES_EMAIL,
                                        "testsales@test.com");
    ...
    while (emails.hasNext()) {
      ...
      if (oneEmail.getHeaderValue("Subject").contains("JoinRejectedSales"))
        ...
        Assert.assertTrue(oneEmail.getHeaderValue("From").contains("support")); // another
                                                                                // is
                                                                                // not
                                                                                // an
                                                                                // admin
  ...
  public void testsSendUserJoinedEmails() throws Exception {
    ...
    cloudAdminConfiguration.setProperty(MailingProperties.CLOUD_ADMIN_MAIL_USER_JOINED_TEMPLATE,
                                        "target/test-classes/template/UserJoinedEmail.html");
    cloudAdminConfiguration.setProperty(MailingProperties.CLOUD_ADMIN_MAIL_USER_JOINED_SUBJECT,
                                        USER_SUBJECT);

    cloudAdminConfiguration.setProperty(MailingProperties.CLOUD_ADMIN_MAIL_USER_JOINED_OWNER_TEMPLATE,
                                        "target/test-classes/template/UserJoinedEmail.html");
    cloudAdminConfiguration.setProperty(MailingProperties.CLOUD_ADMIN_MAIL_USER_JOINED_OWNER_SUBJECT,
                                        OWNER_SUBJECT);
  ...
  public void testIntranetCreatedEmail() throws Exception {
    ...
    cloudAdminConfiguration.setProperty(MailingProperties.CLOUD_ADMIN_MAIL_USER_INTRANET_CREATED_TEMPLATE,
                                        "target/test-classes/template/IntranetCreatedEmail.html");
    cloudAdminConfiguration.setProperty(MailingProperties.CLOUD_ADMIN_MAIL_USER_INTRANET_CREATED_SUBJECT,
                                        MESSAGE_SUBJECT);
  ...
  public void testPasswordRestoreEmail() throws Exception {
    ...
    cloudAdminConfiguration.setProperty(MailingProperties.CLOUD_ADMIN_MAIL_PASSWORD_RESTORE_SUBJECT,
                                        "PasswordRestoreSubject");
    cloudAdminConfiguration.setProperty(MailingProperties.CLOUD_ADMIN_MAIL_PASSWORD_RESTORE_TEMPLATE,
                                        "target/test-classes/template/PasswordRestoreEmail.html");
  ...
  public void testAdminErrorEmail() throws Exception {
    ...
    cloudAdminConfiguration.setProperty(MailConfiguration.CLOUD_ADMIN_MAIL_ADMIN_EMAIL,
                                        "aaa@test.com, bbb@test.com");

    cloudAdminConfiguration.setProperty(MailConfiguration.CLOUD_ADMIN_MAIL_ADMIN_ERROR_SUBJECT,
                                        "AdminErrorSubject");
    cloudAdminConfiguration.setProperty(MailConfiguration.CLOUD_ADMIN_MAIL_ADMIN_ERROR_TEMPLATE,
                                        "target/test-classes/template/AdminErrorEmail.html");
