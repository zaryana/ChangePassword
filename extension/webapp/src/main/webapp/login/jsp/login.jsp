  ...
  <div class="UIPageContainer">
    <div class="UIHeader" id="UIHeader">
      <div class="MainContent">
        ...
        <div class="ClouIntranet FR">
          ...
          <span>The Free Social Intranet for Your Company</span>
        </div>
      </div>
    </div>
          ...
          <div id="formDisplay">
            ...
            <table cols="2">
              <tbody>
                ...
                <tr>
                  <td class="FieldLoginPage">Password:</td>
                  <td id="UIPortalLoginFormControl"
                    onkeypress="eXo.portal.UIPortalControl.onEnterPress(event);"><input type="password"
                    id="password" name="password" class="required InputText" value="" /></td>
                  <td><a class="LoginPage" style="margin-left: 10px;"
                    href="<%=masterhostUrl%>/reset-password.jsp">Forgot Password?</a></td>
                </tr>
                <tr onkeypress="eXo.portal.UIPortalControl.onEnterPress(event);">
                  <td class="FieldLoginPage"></td>
                  <td><input type="checkbox" name="rememberme" id="rememberme" value="true" /><label
                    for="rememberme" class="LabelLoginPage">Remember Me</label></td>
                  <td></td>
                </tr>
                <tr>
                  <td class="FieldLoginPage"></td>
    ...
    <div class="UIFooterPortlet">
      <div class="MainContent ClearFix">
        <p class="FL">
          Cloud Workspaces is Brought to You by <span><a href="http://www.exoplatform.com">eXo</a></span>
        </p>
