		 ...
		 <div class="UIPageBody IndexPage">
			<div class="MainContent" >
				...
				<div class="ClearFix RowOdd">
					<div class="FL BoxImg"><a href="#" title="Connect with your colleagues for an instant enterprise social network"><img src="background/01-mini.png" alt=""/></a></div>
					<div class="BoxText">
				...
				<div class="ClearFix RowEven">
					<div class="FR BoxImg"><a href="#" title="More than a private social network: enterprise wiki, forums, calendars, and more"><img src="background/02-mini.png" alt=""/></a></div>
					<div class="BoxText">
				...
				<div class="ClearFix RowOdd">
					<div class="FL BoxImg"><a href="#" title="Personalized dashboards provide a work start page for every user"><img src="background/03-mini.png" alt=""/></a></div>
					<div class="BoxText">
				...
				<div class="ClearFix RowEven">
					<div class="FR BoxImg"><a href="#" title="Extend and customize your social intranet with the built-in Cloud IDE"><img src="background/04-mini.png" alt=""/></a></div>
					<div class="BoxText">
				...
				<div class="ClearFix RowOdd">
					<div class="FL BoxImg"><a href="#" title="Your personal dashboard on-the-go: native mobile apps for Cloud Workspaces"><img src="background/05-mini.png" alt=""/></a></div>
					<div class="BoxText">
