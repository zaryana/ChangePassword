...
public enum EnumBrowserCommand {
   FIREFOX("*firefox"), MOCK("*mock"), FIREFOX_PROXY("*firefoxproxy"), PIFIREFOX("*pifirefox"), CHROME("*chrome"), IE_EXPLORE_PROXY(
      "*iexploreproxy"),
   ...
   FIREFOX_3("*firefox3"), FIREFOX_2("*firefox2"), SAFARI_PROXY("*safariproxy"), GOOGLE_CHROME("*googlechrome"), SAFARI(
      "*safari"), PIEXPLORE("*piiexplore"), FIREFOX_CHROME("*firefoxchrome"), OPERA("*opera"), IEHTA("*iehta"), CUSTOM(
      "*custom");
