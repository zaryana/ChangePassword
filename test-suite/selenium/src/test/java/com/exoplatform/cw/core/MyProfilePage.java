...
public class MyProfilePage extends BaseTest {
	 ...
	 * @param numMess
	 * @throws Exception
	 *             wait link for avatar from CW page
	 * 
	 */
		...
		new WebDriverWait(driver, 30).until(new ExpectedCondition<Boolean>() {
			...
			public Boolean apply(WebDriver elem) {
				try {
					...
					return saveAvatarButton != null
							&& saveAvatarButton.isDisplayed()
							&& avatarImage != null && avatarImage.isDisplayed();
	 ...
	 * @param numMess
	 * @throws Exception
	 *             wait bottom container load-file form
	 * 
	 * */
	 ...
	 * @param numMess
	 * @throws Exception
	 *             wait basic elements for load files form
	 * 
	 */
		...
		new WebDriverWait(driver, 30).until(new ExpectedCondition<Boolean>() {
			...
			public Boolean apply(WebDriver elem) {
				try {
					...
					return uploadField != null && uploadField.isDisplayed()
							&& uploadInput != null && uploadInput.isDisplayed();
